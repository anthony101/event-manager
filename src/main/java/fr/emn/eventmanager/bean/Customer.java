...
public class Customer implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="customer", targetEntity=Event.class)
    private List<Event> listOfCreatedEvent ;
    ...
    //----------------------------------------------------------------------
    public void setListOfCreatedEvent( List<Event> listOfCreatedEvent ) {
        this.listOfCreatedEvent = listOfCreatedEvent;
    }
    public List<Event> getListOfCreatedEvent() {
        return this.listOfCreatedEvent;
    }
